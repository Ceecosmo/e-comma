...
import galary1 from '../assets/images/5.png'
import galary2 from '../assets/images/7.png'
import galary3 from '../assets/images/9.png'
import galary4 from '../assets/images/5.png'
import DOWNLOADAPP1 from '../assets/images/appstore.png'
import DOWNLOADAPP2  from '../assets/images/google1.png'
      ...
      <div className="container">
        <div className="row pt-2">
         ...
         <div className="col-md-3">
          ...
          <img src={DOWNLOADAPP1} alt="" className='img-fluid' data-aos="fade-up" />
           
          </div>
          <div className="col-md-6">
          <img src={DOWNLOADAPP2} alt="" className='img-fluid' data-aos="fade-up" />
